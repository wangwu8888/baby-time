...
function editPartnerName(){var c=localStorage.getItem('sync_partnerName')||'TA';var n=prompt('输入TA的称呼：',c);if(n&&n.trim()){var nn=n.trim();localStorage.setItem('sync_partnerName',nn);if(typeof Sync!=='undefined')Sync.partnerName=nn;if(typeof Weather!=='undefined')Weather.refresh();if(typeof TreeHole!=='undefined')TreeHole.refresh();showToast('已更新为：'+nn,1500)}}
