...
function setMoodState(s,m,p){Storage.set('moodState_'+p,{status:s,updatedAt:new Date().toISOString(),message:m||''})}
...
function isFirstRun(){return!Storage.get('appReady',false)}
function completeFirstRun(){Storage.set('appReady',true)}
